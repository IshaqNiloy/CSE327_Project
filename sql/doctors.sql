...
--
-- Host: localhost
-- Generation Time: Apr 09, 2019 at 11:27 PM
...
(5, 'heart', 'Dr. Shams Munwar', 'MBBS, MRCP (UK), D.Card. (London)\r\nSenior Consultant – Clinical & Interventional Cardiology', 'Apllo Hospital'),
(6, 'Gyne', 'Dr. Gulshan Ara', '\r\nMBBS, MCPS, MS (Obs./Gynae.)\r\nConsultant – Obstetrics/Gynecology', 'Apllo Hospital');
COMMIT;
